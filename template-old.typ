...
#let note(
  ...
  // font properties
  set text(
    font: "erewhon", // e.g. "STIX Two Text" or "erewhon",
    top-edge: "cap-height", 
...
// raw text (or code)
  show raw: set text(size: 7.5pt/*, font: "JetBrains Mono"*/)

  show raw.where(block: true): it => block(
  //above: 1.0em, // (if paras are indented and short-spaced)
  //below: 1.0em, // (if paras are indented and short-spaced)
    fill: luma(240),
    inset: 10pt,
    radius: 4pt,
    width: 100%,
